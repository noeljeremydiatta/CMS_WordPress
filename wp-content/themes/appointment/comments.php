		...
		<div <?php comment_class('media comment-box'); ?> id="comment-<?php comment_ID(); ?>">
			...
			<div class="media-body">
				<div class="comment-detail">
					...
					<h4 class="comment-detail-title"><?php comment_author(); ?><span class="comment-date"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ));?>"><?php esc_html_e('Posted on', 'appointment'); ?><?php echo comment_time('g:i a'); ?><?php echo " - "; echo comment_date('M j, Y');?></a></span></h4>
