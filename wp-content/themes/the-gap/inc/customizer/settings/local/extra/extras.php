...
$wp_customize->get_control('logo-width')->description =__('When you upload logo click on skip cropping button if you want to use actual size or custom size.','the-gap');
