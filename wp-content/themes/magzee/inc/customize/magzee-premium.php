	...
	public $type = 'upgrade_premium';
	   ...
	   function render_content() {
		?>
			...
			<div>
				<ul>
					<li><a href="http://docs.speciatheme.com/themes/magzee-free/" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/documentation.png"></a></li>
