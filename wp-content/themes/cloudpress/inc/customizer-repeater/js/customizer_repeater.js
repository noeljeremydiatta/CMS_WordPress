...
jQuery(document).ready(function () {
     ...
     *
     */
    theme_conrols.on('click', '#customize-control-cloudpress_service_content .customizer-repeater-new-field', function () {
        if(jQuery("#cloudpress_service_limit").val()==3)
        {
           jQuery(".customizer_cloudpressservice_upgrade_section").show();
           return false;
        }
        else  if(jQuery("#cloudpress_service_limit").val()!=3) 
        {
           var total_services_sections=parseInt(jQuery("#cloudpress_service_limit").val())+1;
           jQuery("#cloudpress_service_limit").val(total_services_sections);
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
               ...
               if(jQuery("#cloudpress_service_limit").val()>3)
            {
               jQuery(".customizer_cloudpressservice_upgrade_section").hide();
            }
        }
...
theme_conrols.on('click', '#customize-control-cloudpress_funfact_content .customizer-repeater-new-field', function () {

        if(jQuery("#cloudpress_funfact_limit").val()==4)
        {
           jQuery(".customizer_cloudpressfunfact_upgrade_section").show();
           return false;
        }
        else if(jQuery("#cloudpress_funfact_limit").val()<4)
        {
           var total_funfact_sections=parseInt(jQuery("#cloudpress_funfact_limit").val())+1;
           jQuery("#cloudpress_funfact_limit").val(total_funfact_sections);
           var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
            /* Clone the first box*/
            ...
            if (typeof field !== 'undefined') {
                ...
                if(jQuery("#cloudpress_funfact_limit").val()>4)
             {
                jQuery(".customizer_cloudpressfunfact_upgrade_section").hide();
             }
         }
    ...
    theme_conrols.on('click', '#customize-control-cloudpress_service_content .social-repeater-general-control-remove-field', function () {
        jQuery(".customizer-repeater-new-field").show();
        var total_services= parseInt(jQuery("#cloudpress_service_limit").val())-1;
       jQuery("#cloudpress_service_limit").val(total_services);
    ...
    theme_conrols.on('click', '#customize-control-cloudpress_funfact_content .social-repeater-general-control-remove-field', function () {
        jQuery(".customizer-repeater-new-field").show();
       var total_funfact= parseInt(jQuery("#cloudpress_funfact_limit").val())-1;
       jQuery("#cloudpress_funfact_limit").val(total_funfact);
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                jQuery(this).parent().remove();
                customizer_repeater_refresh_general_control_values();
